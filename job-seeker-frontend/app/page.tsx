...
import {
  Rocket, User, Building2, Brain, Zap, Video,
  BarChart3, Shield, MessageSquare, ArrowRight,
} from 'lucide-react';
...
export default function Home() {
  ...
  const features = [
    { icon: Brain, title: 'AI Resume Parser', desc: 'Upload your resume and receive instant ATS scoring, keyword analysis, and actionable improvements.' },
    { icon: Zap, title: 'Spot Job Alerts', desc: 'Toggle availability for same-day assignments near you. Accept placement requests with a single tap.' },
    { icon: Video, title: 'Live Interview Rooms', desc: 'Join HD video technical interviews with integrated code editors, whiteboard tools, and secure proctoring.' },
    { icon: BarChart3, title: 'Application Tracker', desc: 'Track every application in a visual Kanban pipeline with real-time status updates.' },
    { icon: Shield, title: 'Proctored Assessments', desc: 'Complete coding and aptitude tests in a secure, AI-monitored environment trusted by top employers.' },
    { icon: MessageSquare, title: 'WhatsApp OTP Login', desc: 'No passwords, no friction. Sign in instantly with a one-time code sent directly to your WhatsApp.' },
  ];
