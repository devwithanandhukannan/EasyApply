...
const sendCompanyVerification = async (companyId, email) => {
...
export const checkCompanySession = async (req, res) => {
    try {
...
export const updateCompanyProfile = async (req, res) => {
    try {
        ...
        const { name, industry, size, registrationNumber, tagline, services, products, seoKeywords, coreValues, gallery, youtubeLink, officeLocations, socialMedia, corporateLink } = req.body;
        ...
        const updatedCompany = await prisma.company.update({
            ...
            data: {
                ...
                seoKeywords: Array.isArray(seoKeywords) ? seoKeywords.map((k) => k.trim()) : undefined,
