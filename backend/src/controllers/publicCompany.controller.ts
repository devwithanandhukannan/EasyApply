...
// ─────────────────────────────────────────────────────────────────────
export const getPublicCompanyJobs = async (req: Request, res: Response) => {
  try {
    const { identifier } = req.params;
...
export const getPublicJobDetails = async (req: Request, res: Response) => {
  try {
    ...
    delete (jobWithStatus as any).applications;
...
// ─────────────────────────────────────────────────────────────────────
export const getAllPublicCompanies = async (req: Request, res: Response) => {
  try {
...
// ─────────────────────────────────────────────────────────────────────
export const searchAllJobs = async (req: Request, res: Response) => {
  try {
    const { 
      search, 
      jobType, 
