...
export const aggregateSalaryBenchmarks = async (title, location, experienceRequired, offeredSalaryStr) => {
...
export const generateFreshCV = async (profile, customPrompt, jobDescription) => {
...
export const optimizeForJD = async (htmlContent, jobDescription) => {
...
export const suggestKeywords = async (htmlContent) => {
...
export const convertToHTML = async (parsedData) => {
...
export const generateJobDescription = async (roughDescription, title, department, locationType, experienceRequired, skills, salaryRange) => {
...
export const rankCandidates = async (jobDescription, requiredSkills, // Json field from JobPosting (array stored as Prisma Json)
candidates, topN, customPrompt) => {
...
export const rankCandidatesAgainstQuery = async (queryDescription, requiredSkills, candidates, topN) => {
...
export const generateOfferLetterTemplate = async (templateName, description, companyName) => {
...
export const scoreResumeContent = async (htmlContent) => {
...
export const generateInlineSuggestions = async (htmlContent) => {
...
export const processTextSelection = async (selectedText, action, customPrompt, context) => {
...
export const generateRegionalResumeTemplate = async (profile, country, style, jobDescription) => {
    const regionalRules = {
...
export const analyzeResume = async (rawText, jobDescription) => {
    const jdSection = jobDescription
