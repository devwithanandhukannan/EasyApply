...
export const sendTeamInviteEmail = async (email, inviteLink, role, companyName) => {
    const roleLabels = {
 ...
 */
export const sendOfferLetterEmail = async (candidateEmail, candidateName, position, companyName, companyLogoUrl, offerId, pdfPath) => {
 ...
 */
export const sendOfferResponseNotification = async (companyEmail, candidateName, position, response, negotiationNote) => {
