...
import fs from 'fs';
import { authenticateToken, requireJobSeeker, } from '../middleware/auth.middleware.ts';
...
import { uploadAndAnalyze, generateCV, convertResumeToHTML, optimizeResume, getKeywordSuggestions, getAllResumes, getResumeById, updateResume, restoreVersion, deleteResume, downloadResume, downloadUploadedPDF, generateRegionalCV, scoreContentOnly, getInlineSuggestions, improveSelectedText, } from '../controllers/resume.controller.ts';
import { applyToJob, getMyApplications, getApplicationDetails, withdrawApplication, } from '../controllers/application.controller.ts';
import { getPublicJobs, getPublicJobDetails, } from '../controllers/publicJobs.controller.ts';
import { getMyScheduledInterviews, confirmInterviewPresence, requestInterviewReschedule, } from '../controllers/interview.controller.ts';
...
//# sourceMappingURL=jobseeker.routes.js.map