...
router.get('/resumes/:id/download-uploaded', downloadUploadedPDF);
router.get('/resumes/:id/download-pdf', downloadUploadedPDF);
router.get('/resumes/:id/view-pdf', downloadUploadedPDF);
